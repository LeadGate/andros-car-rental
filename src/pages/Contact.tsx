      ...
      <Section>
        ...
        <div className="mt-6 max-w-2xl space-y-6">
          <p className="text-foreground leading-relaxed">
            Have a question about renting a car in Andros? We&rsquo;re happy to help.
          </p>
          ...
          <div className="flex items-center gap-3 rounded-lg bg-card p-4 shadow-sm border">
            ...
            <div>
              ...
              <a href="mailto:info@andros-car-rental.com" className="text-primary hover:underline text-sm">info@andros-car-rental.com</a>
            </div>
          </div>
