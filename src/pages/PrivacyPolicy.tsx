    ...
    <Layout>
      <SEOHead
        ...
        jsonLd={[{
          ...
          "@type": "WebPage",
          "name": "Privacy Policy | Andros Car Rental",
          "url": "https://andros-car-rental.com/privacy"
        }]}
      />
      ...
      >
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          Your privacy matters to us. This page outlines how Andros Car Rental collects, uses, and protects your information.
        </p>
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          If you have questions about this privacy policy, please contact us at <a href="mailto:info@andros-car-rental.com" className="text-primary hover:underline">info@andros-car-rental.com</a>.
        </p>
      </Section>
    </Layout>
  );
