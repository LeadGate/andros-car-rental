  ...
  return (
    ...
    <AffiliateWidget />
      ...
      >
          ...
          <WarningBox><p>⚠️ <strong>Warning:</strong> Greek police can fine distracted driving even for holding a coffee cup; under Law 5209/2025 (art. 17) a driver must keep full freedom of movement, so driving one-handed with an object in hand falls in the same €350 fine plus 30-day licence and registration withdrawal category as hand-held phone use.</p></WarningBox>
